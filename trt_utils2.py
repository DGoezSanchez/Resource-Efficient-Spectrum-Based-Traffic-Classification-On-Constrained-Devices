...
class TrtInferFromPlan:
    ...
    def __init__(self, plan_file, batch_size, input_buffer, verbose=True):
        ...
        output_1_binding_index = 1
        output_2_binding_index = 2
        output_3_binding_index = 3
        output_4_binding_index = 4
        output_layer_1 = trt_engine[output_1_binding_index]
        output_layer_2 = trt_engine[output_2_binding_index]
        output_layer_3 = trt_engine[output_3_binding_index]
        output_layer_4 = trt_engine[output_4_binding_index]
        ...
        output_shape_1 = trt_engine.get_binding_shape(output_layer_1)
        output_shape_2 = trt_engine.get_binding_shape(output_layer_2)
        output_shape_3 = trt_engine.get_binding_shape(output_layer_3)
        output_shape_4 = trt_engine.get_binding_shape(output_layer_4)
        
        output_shape_1[batch_dim_index] = self._batch_size
        output_shape_2[batch_dim_index] = self._batch_size
        output_shape_3[batch_dim_index] = self._batch_size
        output_shape_4[batch_dim_index] = self._batch_size
        ...
        trt_out_size_1 = trt.volume(output_shape_1)
        trt_out_size_2 = trt.volume(output_shape_2)
        trt_out_size_3 = trt.volume(output_shape_3)
        trt_out_size_4 = trt.volume(output_shape_4)
        
        output_dtype_1 = trt.nptype(trt_engine.get_binding_dtype(output_layer_1))
        output_dtype_2 = trt.nptype(trt_engine.get_binding_dtype(output_layer_2))
        output_dtype_3 = trt.nptype(trt_engine.get_binding_dtype(output_layer_3))
        output_dtype_4 = trt.nptype(trt_engine.get_binding_dtype(output_layer_4))
        
        self.output_buff_1 = MappedBuffer(trt_out_size_1, output_dtype_1)
        self.output_buff_2 = MappedBuffer(trt_out_size_2, output_dtype_2)
        self.output_buff_3 = MappedBuffer(trt_out_size_3, output_dtype_3)
        self.output_buff_4 = MappedBuffer(trt_out_size_4, output_dtype_4)
        ...
        if verbose:
            ...
            print('    Name               : {}'.format(output_layer_1))
            print('    Name               : {}'.format(output_layer_2))
            print('    Name               : {}'.format(output_layer_3))
            print('    Name               : {}'.format(output_layer_4))
            print('    Shape              : {}'.format(output_shape_1))
            print('    Shape              : {}'.format(output_shape_2))
            print('    Shape              : {}'.format(output_shape_3))
            print('    Shape              : {}'.format(output_shape_4))
            print('    dtype              : {}'.format(output_dtype_1.__name__))
            print('    dtype              : {}'.format(output_dtype_2.__name__))
            print('    dtype              : {}'.format(output_dtype_3.__name__))
            print('    dtype              : {}'.format(output_dtype_4.__name__))
            print('  Receiver Output Size : {:,} samples'.format(sdr_out_size))
            print('  TensorRT Input Size  : {:,} samples'.format(trt_in_size))
            print('  TensorRT Output Size : {:,} samples'.format(trt_out_size_1))
            print('  TensorRT Output Size : {:,} samples'.format(trt_out_size_2))
            print('  TensorRT Output Size : {:,} samples'.format(trt_out_size_3))
            print('  TensorRT Output Size : {:,} samples'.format(trt_out_size_4))
    ...
    def feed_forward(self):
        ...
        buffers = [self.input_buff.device, self.output_buff_1.device, self.output_buff_2.device, self.output_buff_3.device, self.output_buff_4.device]
